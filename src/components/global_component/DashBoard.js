              ...
              <div className="card-body">
                <div className="row no-gutters align-items-center">
                  <div className="col mr-2">
                    ...
                    <div className="row no-gutters align-items-center">
                      <div className="col-auto">
                        <div className="h5 mb-0 ml-3 mr-2 font-weight-bold text-gray-800">
                          50%
                        </div>
                      </div>
                      <div className="col">
            ...
            <div className="card shadow mb-4">
              ...
              <div className="card-body">
                ...
                <div className="progress mb-4">
                  <div
                    className="progress-bar bg-danger progress-bar2"
                    role="progressbar"
                    //style="width: 20%"
                    aria-valuenow="20"
                    aria-valuemin="0"
                ...
                <div className="progress mb-4">
                  <div
                    className="progress-bar bg-warning progress-bar3"
                    role="progressbar"
                    //style="width: 40%"
                    aria-valuenow="40"
                    aria-valuemin="0"
            ...
            <div className="card shadow mb-4">
              ...
              <div className="card-body">
                <div className="text-center">
                  <img
                    className="img-fluid px-3 px-sm-4 mt-3 mb-4 img-fluid1"
                    //style="width: 25rem;"
